...
### Listing all persons with a certain tag : `tagged`
Shows a list of all persons in the address book with a certain tag. <br>
Format: `tagged`

Examples:
* `tagged owesmoney`<br>
  Returns all people with the tag owesmoney
...
Examples: 
* `find John`<br>
  Returns `John Doe` but also `john`
